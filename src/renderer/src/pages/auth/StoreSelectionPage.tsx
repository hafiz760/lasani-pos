  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden -z-10">
        <div className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] bg-[#E8705A]/5 rounded-full blur-[120px]" />
      ...
      <header className="fixed top-0 left-0 right-0 h-20 px-8 flex items-center justify-between border-b border-border/50 bg-background/50 backdrop-blur-md z-50">
        <div className="flex items-center gap-2">
          <div className="h-10 w-10 rounded-xl bg-[#E8705A] flex items-center justify-center">
            <Smartphone className="h-6 w-6 text-black" />
          </div>
          <span className="text-2xl font-bold bg-linear-to-r from-[#E8705A] to-[#D4604C] bg-clip-text text-transparent">
            ShopPOS
          </span>
        </div>
        ...
        {isRefreshing ? (
          <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-4 animate-in fade-in duration-500">
            <div className="relative">
              ...
              <Loader2 className="h-16 w-16 animate-spin text-[#E8705A] absolute top-0 left-0" />
            </div>
