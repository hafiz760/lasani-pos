          ...
          >
              ...
              <DropdownMenu>
                ...
                >
                  <DropdownMenuItem
                    ...
                    onClick={(e) => {
                      e.stopPropagation()
                      handleManagePermissions(role._id)
                    }}
                  >
            ...
            <CardContent>
              ...
              <div className="mt-4 flex items-center gap-2">
                <Badge
                  variant="outline"
                  className="bg-[#E8705A]/10 text-[#E8705A] border-[#E8705A]/20"
                >
                  System Role
                </Badge>
      ...
      <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
        <DialogContent className="sm:max-w-[425px] bg-card border-border text-foreground">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter the basic identity for this role. You can manage its specific permissions after
              creation.
            </DialogDescription>
          </DialogHeader>
