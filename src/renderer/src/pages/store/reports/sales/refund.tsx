        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Invoice #{sale.invoiceNumber || sale._id.substring(0, 8)} • Return items from this
              sale
            </p>
          </div>
        </div>
          ...
          <CardContent className="p-5">
            ...
            {refundTotal > refundableAmount && (
              <div className="mt-3 bg-red-500/10 border border-red-500/20 rounded-lg p-3 flex items-center gap-3 text-red-600 animate-in fade-in slide-in-from-top-2">
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-tighter leading-none">
                    Limit Exceeded
                  </p>
                  <p className="text-[10px] opacity-80">
                    You cannot refund more than the amount originally paid.
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 gap-3">
              {sale.items.map((item: any, idx: number) => {
                ...
                return (
                  <Card
                    key={idx}
                    className={`group border transition-all duration-300 shadow-sm overflow-hidden ${
                      currentRefundQty > 0
                      ...
                      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex-1 min-w-0 w-full">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-0.5">
                              <span className="text-[10px] uppercase font-black text-muted-foreground tracking-widest block italic">
                                Bought
                              </span>
                        ...
                        <div className="flex items-center gap-4 w-full md:w-auto mt-2 md:mt-0 pt-3 md:pt-0 border-t md:border-t-0 border-border/30">
                          <div className="flex flex-col items-center md:items-end gap-1.5">
                            <Label className="text-[9px] font-black uppercase text-muted-foreground block text-center">
                              Return Qty
                            </Label>
                            <Input
                              type="number"
                              ...
                              className={`h-11 w-20 text-center text-lg font-black transition-all bg-white shadow-sm ${
                                currentRefundQty > 0
                                  ? 'border-[#E8705A] focus-visible:ring-[#E8705A]'
                                  : ''
                              }`}
                              placeholder="0"
                          ...
                          {currentRefundQty > 0 && (
                            <div className="text-right flex-1 md:flex-none animate-in fade-in slide-in-from-right-4">
                              <div className="text-[9px] font-black text-[#E8705A] uppercase tracking-widest mb-0.5 italic text-center">
                                Credit
                              </div>
              ...
              <CardContent className="p-4">
                {refundTotal > 0 ? (
                      ...
                      {sale.items
                        ...
                        .map((item: any, idx: number) => {
                          ...
                          return (
                            <div
                              key={idx}
                              className="flex justify-between items-start text-xs group animate-in fade-in slide-in-from-bottom-1"
                            >
                              <div className="flex flex-col">
                                <span className="font-extrabold text-foreground leading-none mb-1">
                                  {item.productName || item.product?.name}
                                </span>
                              ...
                              <span className="font-black text-[#E8705A]">
                    ...
                    <div className="border-t-2 border-dashed border-border pt-4 space-y-4">
                      ...
                      <div className="space-y-3 mt-4 pt-3 border-t border-border/50">
                        <div className="space-y-1.5">
                          <Label className="text-[9px] font-black uppercase tracking-widest text-muted-foreground ml-0.5">
                            Payment Method
                          </Label>
                          <Select value={refundMethod} onValueChange={setRefundMethod}>
                            ...
                            <SelectContent className="bg-popover border-border text-popover-foreground">
                              <SelectItem value="Cash" className="font-bold py-2 text-xs">
                                Cash Payment
                              </SelectItem>
                              <SelectItem value="Bank Transfer" className="font-bold py-2 text-xs">
                                Digital Transfer
                              </SelectItem>
                            </SelectContent>
                          </Select>
                  ...
                  <div className="py-10 text-center text-muted-foreground border-2 border-dashed border-muted/50 rounded-xl">
                    ...
                    <h4 className="font-black text-sm text-foreground mb-1 uppercase tracking-tighter">
                      Basket is Empty
                    </h4>
                    <p className="text-[10px] px-6 leading-relaxed font-medium">
                      Select items from the left to begin.
                    </p>
                  </div>
                )}
              </CardContent>
